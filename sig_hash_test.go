...
func TestSigHash(t *testing.T) {
	tests := []struct {
		...
		// I think these are just randomized and since I added what I believe is the correct
		// behavior for the OP_CODESEPARATOR the ones that randomly have OP_CODESEPARATOR aren't
		// properly only hashing the locking script after that. --ce
	...
	for _, tt := range tests {
		t.Run(tt.signature_hash, func(t *testing.T) {
			...
			t.Logf("Script : %s", bitcoin.Script(script))
